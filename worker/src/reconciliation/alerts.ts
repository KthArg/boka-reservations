...
export const MSG_UNCLAIMED = '[reconcile] reserva diferida confirmada sin cobro iniciado';
export const MSG_MANUAL_REFUND =
  '[reconcile] cobro que requiere reembolso manual (doble cobro o refund bloqueado)';
...
// reserva ni por ciclo. En dev/CI (sin SENTRY_DSN) es no-op. Nivel error para la plata que
// requiere acción manual (spec 0029), warning para lo demás.
